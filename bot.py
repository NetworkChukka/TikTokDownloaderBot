...
START_BUTTONS=[
    [
        InlineKeyboardButton('ɢʀᴏᴜᴘ', url='https://t.me/anonymousbotzchat'),
        InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url='https://t.me/anonymousbotz'),
    ],
    [InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/networkchukka')],
]
